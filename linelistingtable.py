...
def case_seriousness_without_lookup(LL_path, age_type, file_path_case_seriousness, line_listing_table_path, paragraph_path):
    ...
    if age_type == 18:
        filtered_df = df1[df1['Age'] > 0]
    elif age_type == 65:
        filtered_df = df1[df1['Age'] >= 65]

    df_case_seriousness = filtered_df.to_excel(file_path_case_seriousness, index=False)

    df_creation_excel = pd.read_excel(file_path_case_seriousness)
...
# # Example usage
# line_listing_table_path = 'C:\\Users\\2113196\\Downloads\\line_listing_table.xlsx'
# create_excel_file(line_listing_table_path)
...
def line_listing_table_logic():
    # report_type_unique = df_creation_excel['Report Type'].unique()
    report_type_unique = ['Clinical Trial', 'Spontaneous Report', 'Literature', 'Post Market Survey']
...
# AI_for_better_table_to_text(updated_paragraph1, updated_paragraph2)

# # Example usage
# LL_reporting_path = "C:\\Users\\2113196\\Downloads\\LL_reporting.xlsx"
# LL_cumulative_path = "C:\\Users\\2113196\\Downloads\\LL_reporting.xlsx"
# Cognizant_CRS_path = "C:\\Users\\2113196\\Downloads\\Cognizant_CRS.xlsx"

# Get user input
# user_choice = input(f"""Choose a function to run:
#                     Case Seriousness : 1
#                     Event Seriousness : 2 
#                     """)
# type_of_population = input(f"""Choose a function to run:
#                     Use in Pediatric population : 1
#                     Use in Geriatric population : 2
#                     Drug overdose : 3
#                     Drug abuse/miuse : 4
#                     Medication Error : 5
#                     Intestinal perforation, obstruction and ileus : 6
#                     """)

# Execute the chosen function
# if user_choice == '1':
#     if type_of_population == '1':
#         age_type = 18
#         df_case_seriousness = case_seriousness_without_lookup(LL_reporting_path, age_type)
#         df_case_seriousness = case_seriousness_without_lookup(LL_cumulative_path, age_type)
#     if type_of_population == '2':
#         age_type = 65
#         df_case_seriousness = case_seriousness_without_lookup(LL_reporting_path, age_type)
#         df_case_seriousness = case_seriousness_without_lookup(LL_cumulative_path, age_type)
#     if type_of_population == '3':
...
#         df_case_seriousness = case_seriousness(LL_reporting_path, Cognizant_CRS_path, lookup_column)
#         df_case_seriousness = case_seriousness(LL_cumulative_path, Cognizant_CRS_path, lookup_column)

#     if type_of_population == '4':
...
#         df_case_seriousness = case_seriousness(LL_reporting_path, Cognizant_CRS_path, lookup_column)
#         df_case_seriousness = case_seriousness(LL_cumulative_path, Cognizant_CRS_path, lookup_column)
#     if type_of_population == '5':
#         lookup_column = """SMQ (Broad) Medication errors"""
#         df_case_seriousness = case_seriousness(LL_reporting_path, Cognizant_CRS_path, lookup_column)
#         df_case_seriousness = case_seriousness(LL_cumulative_path, Cognizant_CRS_path, lookup_column)
...
#     if type_of_population == '1':
#         age_type = 18
#         df_event_seriousness = event_seriousness_without_lookup(LL_reporting_path, age_type)
#     if type_of_population == '2':
#         age_type = 65
#         df_event_seriousness = event_seriousness_without_lookup(LL_reporting_path, age_type)
#     if type_of_population == '3':
#         lookup_column = """Overdose: cases reporting PTs ‘Accidental overdose’, ‘Accidental poisoning’, ‘Chemical poisoning’, ‘Exposure to toxic agent’, ‘Intentional overdose’, overdose’, Poisoning’, ‘Poisoning deliberate’, ‘Prescribed overdose’, ‘Systemic toxicity’ and ‘Toxicity to various agents’. """
#         df_event_seriousness = event_seriousness(LL_reporting_path, Cognizant_CRS_path, lookup_column)
#     if type_of_population == '4':
#         lookup_column = """Drug abuse/ Misuse: SMQ (narrow) ‘Drug abuse and dependence’ and PTs: ‘Dependence’, ‘Drug diversion’, ‘Intentional product use issue’, ‘Narcotic bowel syndrome’, ‘ Prescription from tampering’, ‘ Prescription drug used without prescription’, ‘Performance enhancing product use’, ‘Product use in unapproved therapeutic environment’, ‘Substance-induced mood disorder’, ‘Substance-induced psychotic disorder’. """
#         df_event_seriousness = event_seriousness(LL_reporting_path, Cognizant_CRS_path, lookup_column)
#     if type_of_population == '5':
#         lookup_column = """SMQ (Broad) Medication errors"""
#         df_event_seriousness = event_seriousness(LL_reporting_path, Cognizant_CRS_path, lookup_column)
#     if type_of_population == '6':
#         lookup_column = """SMQ (narrow) Gastrointestinal peforatrion, ulceration, haemorrhage ot obstruction"""
#         df_event_seriousness = event_seriousness(LL_reporting_path, Cognizant_CRS_path, lookup_column)

#     df_creation_excel = df_event_seriousness
# else:
...
paragraph_path = 'C:\\Users\\2113196\\Downloads\\off_label_event_seriousness_cumulative'
file_path_case_seriousness = 'C:\\Users\\2113196\\Downloads\\off_label_event_seriousness_reporting.xlsx'
line_listing_table_path = 'C:\\Users\\2113196\\Downloads\\off_label_event_distribution_reporting.xlsx'
...
# file_path_case_seriousness = 'C:\\Users\\2113196\\Downloads\\case_seriousness_reporting.xlsx'
# line_listing_table_path = 'C:\\Users\\2113196\\Downloads\\line_listing_table_reporting.xlsx'
# df_case_seriousness = case_seriousness_without_lookup(LL_reporting_path, 18, file_path_case_seriousness, line_listing_table_path)


# file_path_case_seriousness = 'C:\\Users\\2113196\\Downloads\\case_seriousness_cumulative.xlsx'
# line_listing_table_path = 'C:\\Users\\2113196\\Downloads\\line_listing_table_cumulative.xlsx'
# df_case_seriousness = case_seriousness_without_lookup(LL_cumulative_path, 65, file_path_case_seriousness, line_listing_table_path)


# file_path_case_seriousness = 'C:\\Users\\2113196\\Downloads\\medication_error_case_seriousness_reporting.xlsx'
# line_listing_table_path = 'C:\\Users\\2113196\\Downloads\\medication_error_line_listing_table_reporting.xlsx'
# lookup_column = """SMQ (Broad) Medication errors"""
# case_seriousness(LL_reporting_path, Cognizant_CRS_path, lookup_column, file_path_case_seriousness, line_listing_table_path)

# file_path_case_seriousness = 'C:\\Users\\2113196\\Downloads\\medication_error_case_seriousness_cumulative.xlsx'
# line_listing_table_path = 'C:\\Users\\2113196\\Downloads\\medication_error_line_listing_table_cumulative.xlsx'
# lookup_column = """SMQ (Broad) Medication errors"""
# case_seriousness(LL_cumulative_path, Cognizant_CRS_path, lookup_column, file_path_case_seriousness, line_listing_table_path)

# file_path_case_seriousness = 'C:\\Users\\2113196\\Downloads\\drug_overdose_case_seriousness_reporting.xlsx'
# line_listing_table_path = 'C:\\Users\\2113196\\Downloads\\drug_overdose_line_listing_table_reporting.xlsx'
# lookup_column = """Overdose: cases reporting PTs ‘Accidental overdose’, ‘Accidental poisoning’, ‘Chemical poisoning’, ‘Exposure to toxic agent’, ‘Intentional overdose’, overdose’, Poisoning’, ‘Poisoning deliberate’, ‘Prescribed overdose’, ‘Systemic toxicity’ and ‘Toxicity to various agents’. """
# case_seriousness(LL_reporting_path, Cognizant_CRS_path, lookup_column, file_path_case_seriousness, line_listing_table_path)

# file_path_case_seriousness = 'C:\\Users\\2113196\\Downloads\\drug_misuse_case_seriousness_reporting.xlsx'
# line_listing_table_path = 'C:\\Users\\2113196\\Downloads\\drug_misuse_line_listing_table_reporting.xlsx'
# lookup_column = """Drug abuse/ Misuse: SMQ (narrow) ‘Drug abuse and dependence’ and PTs: ‘Dependence’, ‘Drug diversion’, ‘Intentional product use issue’, ‘Narcotic bowel syndrome’, ‘ Prescription from tampering’, ‘ Prescription drug used without prescription’, ‘Performance enhancing product use’, ‘Product use in unapproved therapeutic environment’, ‘Substance-induced mood disorder’, ‘Substance-induced psychotic disorder’. """
# case_seriousness(LL_reporting_path, Cognizant_CRS_path, lookup_column, file_path_case_seriousness, line_listing_table_path)

# paragraph_path = 'C:\\Users\\2113196\\Downloads\\intestinal_performation_event_seriousness_cumulative'
# file_path_case_seriousness = 'C:\\Users\\2113196\\Downloads\\intestinal_performation_event_seriousness_reporting.xlsx'
# line_listing_table_path = 'C:\\Users\\2113196\\Downloads\\intestinal_performation_event_line_listing_table_reporting.xlsx'
...
# paragraph_path = 'C:\\Users\\2113196\\Downloads\\HLGT_and_HLT_case_seriousness_cumulative'
# file_path_case_seriousness = 'C:\\Users\\2113196\\Downloads\\HLGT_and_HLT_case_seriousness_cumulative.xlsx'
# line_listing_table_path = 'C:\\Users\\2113196\\Downloads\\HLGT_and_HLT_case_distribution_cumulative.xlsx'
# lookup_column = """HLGT ‘Gastrointestinal ulceration and perforation’ and  ‘Gastrointestinal haemorrhages’ and HLT ‘Gastrointestinal inflammatory disorders NEC’, ‘Gastrointestinal necrosis and gangrene (excl. gangrenous hernia)’ and ‘Gastrointestinal necrosis and vascular insufficiency’"""
...
# paragraph_path = 'C:\\Users\\2113196\\Downloads\\HLGT_and_HLT_event_seriousness_cumulative'
# file_path_case_seriousness = 'C:\\Users\\2113196\\Downloads\\HLGT_and_HLT_event_seriousness_reporting.xlsx'
# line_listing_table_path = 'C:\\Users\\2113196\\Downloads\\HLGT_and_HLT_event_distribution_reporting.xlsx'
# lookup_column = """HLGT ‘Gastrointestinal ulceration and perforation’ and  ‘Gastrointestinal haemorrhages’ and HLT ‘Gastrointestinal inflammatory disorders NEC’, ‘Gastrointestinal necrosis and gangrene (excl. gangrenous hernia)’ and ‘Gastrointestinal necrosis and vascular insufficiency’"""
# event_seriousness(LL_cumulative_path, Cognizant_CRS_path, lookup_column, file_path_case_seriousness, line_listing_table_path, paragraph_path)

# paragraph_path = 'C:\\Users\\2113196\\Downloads\\drug_abuse_case_seriousness_cumulative'
# file_path_case_seriousness = 'C:\\Users\\2113196\\Downloads\\drug_abuse_case_seriousness_cumulative.xlsx'
# line_listing_table_path = 'C:\\Users\\2113196\\Downloads\\drug_abuse_case_distribution_cumulative.xlsx'
# lookup_column = """Drug abuse/ Misuse: SMQ (narrow) ‘Drug abuse and dependence’ and PTs: ‘Dependence’, ‘Drug diversion’, ‘Intentional product use issue’, ‘Narcotic bowel syndrome’, ‘ Prescription from tampering’, ‘ Prescription drug used without prescription’, ‘Performance enhancing product use’, ‘Product use in unapproved therapeutic environment’, ‘Substance-induced mood disorder’, ‘Substance-induced psychotic disorder’. """

# case_seriousness(LL_cumulative_path, Cognizant_CRS_path, lookup_column, file_path_case_seriousness, line_listing_table_path, paragraph_path)

# paragraph_path = 'C:\\Users\\2113196\\Downloads\\drug_abuse_event_seriousness_cumulative'
# file_path_case_seriousness = 'C:\\Users\\2113196\\Downloads\\drug_abuse_event_seriousness_reporting.xlsx'
# line_listing_table_path = 'C:\\Users\\2113196\\Downloads\\drug_abuse_event_distribution_reporting.xlsx'
# lookup_column = """Drug abuse/ Misuse: SMQ (narrow) ‘Drug abuse and dependence’ and PTs: ‘Dependence’, ‘Drug diversion’, ‘Intentional product use issue’, ‘Narcotic bowel syndrome’, ‘ Prescription from tampering’, ‘ Prescription drug used without prescription’, ‘Performance enhancing product use’, ‘Product use in unapproved therapeutic environment’, ‘Substance-induced mood disorder’, ‘Substance-induced psychotic disorder’. """
# event_seriousness(LL_cumulative_path, Cognizant_CRS_path, lookup_column, file_path_case_seriousness, line_listing_table_path, paragraph_path)